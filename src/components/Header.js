        ...
        return(
            <div class="w3-content" style={{maxWidth:"1400px"}}>
                ...
                <header class="w3-container w3-center w3-padding-32"> 
                    <h1><b>MY BLOG</b></h1>
                    <p>Welcome to the blog of Event Management <span class="w3-tag"></span></p> 
                </header>
                ...
                <div class="w3-row">
                    ...
                    <div class="w3-col l8 s12">
                        ...
                        <div class="w3-card-4 w3-margin w3-white">
                            ...
                            <div class="w3-container">
                                ...
                                <h5>Title description, <span class="w3-opacity">April 1, 2021</span></h5>
                            </div>
                            <div class="w3-container">
                    ...
                    <div class="w3-col l4">
                        ...
                        <div class="w3-card w3-margin w3-margin-top">
                            ...
                            <div class="w3-container w3-white">
                                <h4><b>Birthday Events</b></h4>
                                <h5>Title description, <span class="w3-opacity">April 8, 2021</span></h5>
                    ...
                    <div class="w3-col l4">
                        <div class="w3-card w3-margin w3-margin-top">
                            ...
                            <div class="w3-container w3-white">
                                <h4>Corporate Function Events</h4>
                                <h5>Title description, <span class="w3-opacity">April 12, 2021</span></h5>
                    ...
                    <div class="w3-col l4">
                        <div class="w3-card w3-margin w3-margin-top">
                            ...
                            <div class="w3-container w3-white">
                                <h4>Ceremony Events</h4>
                                <h5>Title description, <span class="w3-opacity">April 22, 2021</span></h5>
                            </div>
                            <div class="w3-container w3-white">
